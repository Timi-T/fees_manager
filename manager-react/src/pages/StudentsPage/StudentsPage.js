		...
		return (
			<div className="filter-component" id="ClassFilter">
				...
				<div id="class-options">
					{
						classnames.map((cls) => {
							const checkValue = checkedClassrooms[classnames.indexOf(cls)]
							return(
								<div key={cls} className="c-o">
									<input type="checkbox" id={cls + 'opt'} value={cls} checked={checkValue} onChange={() => FilterClass(classnames.indexOf(cls))}></input>
			...
			<div id="students-con">
				<div id="top-section">
					<div id="regstu" onClick={() => {
						...
						<BigBtn id='reg-btn' color="white" bcolor="rgb(60, 7, 60)" text="Register Student"/>
					</div>
